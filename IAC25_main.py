...
n = 1000
mp_samples = np.random.normal(2000, 10, n)      # Monte Carlo for mp
dv_samples = np.random.normal(2500, 50, n)   # Monte Carlo for dv
...
models = [
    ...
    ("mixed_physical", mixed_physical_estimation),
]
